package md5a851b53f5a4adfb0e4ee530599be6b2a;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("EpicWorkout.Droid.Fragments.MyValueEventListener, EpicWorkout.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MyValueEventListener.class, __md_methods);
	}


	public MyValueEventListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MyValueEventListener.class)
			mono.android.TypeManager.Activate ("EpicWorkout.Droid.Fragments.MyValueEventListener, EpicWorkout.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
