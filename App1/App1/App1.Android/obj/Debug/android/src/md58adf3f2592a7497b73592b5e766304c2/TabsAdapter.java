...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.TabsAdapter, App1.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TabsAdapter.class, __md_methods);
	}
	...
	public TabsAdapter (android.support.v4.app.FragmentManager p0) throws java.lang.Throwable
	{
		...
		if (getClass () == TabsAdapter.class)
			mono.android.TypeManager.Activate ("App1.Droid.TabsAdapter, App1.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.v4, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
